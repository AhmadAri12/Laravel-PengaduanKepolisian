...
<div class="form-container">
    <form action="/kategori/update/{{ $kategori->id }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="id" id="id" value="{{ $kategori->id }}" readonly>
        </div>
        <div class="form-group">
            <label for="nama_pengaduan">Nama Kategori</label>
            <input type="text" name="nama_pengaduan" id="nama_pengaduan" value="{{ $kategori->nama_pengaduan }}" required>
        </div>
        <div class="form-group">
