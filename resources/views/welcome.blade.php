...
<body>
    ...
    <nav>
        ...
        <div class="logo-container">
            <img src="{{ asset('assets/gambar/logo.png') }}" alt="Logo Pengaduan" width="60%" class="logo" />
        </div>
        <ul>
            <li><a href="/">Layanan</a></li>
            <li><a href="#">History Pengaduan</a></li>
            <li><a href="/kategori">Kategori Pengaduan</a></li>
        ...
        <div class="container-slider">
            <div class="img-slider">
                <div class="slide active">
                    <img src="{{ asset('assets/gambar/slider/1.png') }}" alt="slider 1">
                </div>
                <div class="slide">
                    <img src="{{ asset('assets/gambar/slider/2.png') }}" alt="slider 2">
                </div>
                <div class="slide">
                    <img src="{{ asset('assets/gambar/slider/3.png') }}" alt="slider 3">
                </div>
                <div class="slide">
                    <img src="{{ asset('assets/gambar/slider/4.png') }}" alt="slider 4">
                </div>
                <div class="slide">
                    <img src="{{ asset('assets/gambar/slider/5.png') }}" alt="slider 5">
                </div>
